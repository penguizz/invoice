        ...
        <form>
          ...
          <div class="form-group col-md-7">
            ...
            <div class="pull-right">
                ...
                <a href="/customer/create"><button type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add</button></a>
            </div>
      ...
      <div class="panel-body">
        ...
        <tbody>
            <tr>    
                ...
                <td><a href="#" data-toggle="modal" data-target="#myModal1" style="color:#333">Geodis Wilson Thai Co.,Ltd <br/>จีโอดิส วิลสัน (ประเทศไทย) จำกัด (มหาชน) </a></td>
          ...
          <tr>
                ...
                <td><a href="#" data-toggle="modal" data-target="#myModal2" style="color:#000">บริษัท แอร์พอร์ตเนิสซิ่งโอม จำกัด(โรงพยาบาล บี.แคร์ เมดิคอลเซ็นเตอร์)</a></td>
            ...
            <tr>
                ...
                <td><a href="#" data-toggle="modal" data-target="#myModal1" style="color:#000">Geodis Wilson Thai Co.,Ltd <br/>จีโอดิส วิลสัน (ประเทศไทย) จำกัด (มหาชน) </a></td>
                <td>207, Sukhumvit 50 Rd.,Soi SungautaiPrakhang, Klongtoey, Bangkok 10260 <br/> 207 ซอยแสงอุทัย ถนนสุขุมวิท 50 พระโขนง คลองเตย กรุงเทพมหานคร 10260</td>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">บริษัท แอร์พอร์ตเนิสซิ่งโอม จำกัด(โรงพยาบาล บี.แคร์ เมดิคอลเซ็นเตอร์)</h4>
            </div>
            <div class="modal-body">
                <form>
                    <fieldset>
                        <p>ชื่อบริษัท : บริษัท แอร์พอร์ตเนิสซิ่งโอม จำกัด(โรงพยาบาล บี.แคร์ เมดิคอลเซ็นเตอร์)</p>
                        <p>Company Name : -</p>
                            <p>ที่อยู่ : 29 หมู่ที่ 6 ถนนพหลโยธิน แขวงสายไหม เขตสายไหม กรุงเทพฯ 10220</p>
                            <p>Address : -</p>
                            <p>TaxID : </p>
                            <p>เบอร์โทร : </p>
                            <p>เบอร์แฟ็กซ์ : </p>
