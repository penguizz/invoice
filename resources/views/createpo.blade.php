      ...
      <div class="col-md-12 col-lg-12" id="product-detail">                  
          <table class="table table-bordered" style="width: 100%;">  
            <tr>
              <td style="width:70%">
                  ...
                  <div class="col-md-2 pull-left">
                      <button type="button" class="btn btn-primary btn-md edit-content" href="/vendor/create?vendortype=supplier">เพิ่มผู้ขายใหม่</p></button>
                  </div>
               </td>
            ...
            <tr>
              <td>
                  ...
                  <div class="col-md-10">                  
                      <input type="hidden" name="po_contact_person" id="po_contact_person_input">
                      <input type="hidden" name="po_contact_tel" id="po_contact_tel_input">
                      <input type="hidden" name="po_contact_email" id="po_contact_email_input">  
                      <span id="po_contact_person"></span>
                      Mobile: <span id="po_contact_tel"></span> 
                      <br>
                      E-mail: <span id="po_contact_email"></span>
                      </p>
                  </div>
                  <div class="col-md-2">
                     ...
                     <tr>
                        <td>
                           ...
                           <div class="col-md-8 col-lg-8">
                              <input type="text" class="form-control" name="po_no" style="width: 100%">
                           </div>
                        </td>
                     </tr>
                     <tr>
                        <td>
                           ...
                           <div class="col-md-8 col-lg-8"><input type="date" class="form-control" name="po_date" id="po_date" style="width: 100%"></div>
                        </td>
                     </tr>
                     <tr>
                        <td>
                           ...
                           <div class="col-md-8 1col-lg-8">
                              <input type="text" class="form-control" name="po_revision" style="width: 100%">
                           </div>
                        </td>
                     </tr>
                     <!-- <tr>
         ...
         <table class="table table-bordered" style="width: 100%;">
            ...
            <tr v-for="(item,index) in items">
                ...
                <td><input type="text" class="form-control" name="po_detail_part_no[]"></td>
                <td><input type="text" class="form-control" name="po_description[]"></td>
                <td><input type="text" class="form-control numberonly quantity" maxlength="3" name="po_quantity[]"></td>
                <td><input type="text" class="form-control numberonlydot price" maxlength="9" name="po_unit_price[]"></td>
                <td><input type="text" class="form-control po_amount" readonly="" name="po_amount[]"></td>
            ...
            <tr>
              <td colspan="3" rowspan="5">
                ...
                <b>Payment/การชำระเงิน</b></p>
                  <div class="checkbox">
                    <label><input type="checkbox" name="payment_credit_1" value="Y">ชำระเงินโดย โอนเข้าบัญชีของบริษัทผู้ขาย 1-3 วันก่อนรับสินค้าหรือบริการ</p></label>
                  </div>
                  <div class="checkbox">
                    <label><input type="checkbox" name="payment_credit_2" value="Y">เครดิต 30 วัน ชำระหลังได้รับสินค้าเรียนร้อยแล้ว</p></label>
                  </div>
              </td>
              ...
              <td colspan="2">
                <input type="text" class="form-control" readonly="" id="po_sub_total" name="po_sub_total">
              </td>
            </tr>
            <tr>
              <td colspan="2">
              ...
              <td colspan="2">
                <input type="text" class="form-control numberonlydot" id="po_discount" name="po_discount">
              </td>
            </tr>
            <tr>
              <td colspan="2">
              ...
              <td colspan="2">
                <input type="text" class="form-control" readonly="" id="po_price_after_discount" name="po_price_after_discount">
              </td>
            </tr>
            <tr>
              <td colspan="2">                          
              ...
              <td colspan="2">
                <input type="text" class="form-control" readonly="" id="po_vat_money" name="po_vat_money">
              </td>
            </tr>
            <tr>
              <td colspan="2">
              ...
              <td colspan="2">
                <input type="text" class="form-control" readonly="" id="po_total" name="po_total">
              </td>
            </tr> 
         </table>
